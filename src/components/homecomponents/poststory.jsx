    ...
    return (
        <div className="fixed inset-0 bg-[#333333] flex items-center justify-center z-50 overflow-hidden">
            ...
            <div className="relative">
                <div className="rounded-2xl overflow-hidden" style={{ width: '350px', height: '600px' }}>
                    {/* Story Content Area */}
                    <div
                        ref={containerRef}
                        className={`relative w-full h-full ${storyType === 'text' ? 'bg-gradient-to-br from-purple-500 to-pink-500' : 'bg-gray-200'
                            }`}
