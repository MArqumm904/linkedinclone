...
const VideoComponent = ({
  videoUrl,
  title = "Hard Work Today Means Success Tomorrow",
}) => {
  ...
  return (
    <div
      className="relative w-full h-96 bg-teal-600 overflow-hidden group"
    ...
    >
      ...
      {!isPlaying && (
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          {/* Title */}
          <h2 className="text-xl font-bold mb-4 text-center px-4">{title}</h2>
          ...
          <div className="flex items-center space-x-2 mt-4">
            <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
              <span className="text-teal-600 font-bold text-sm">M</span>
            </div>
            <span className="text-sm font-medium">MRA Consulting</span>
          </div>
        </div>
      )}
