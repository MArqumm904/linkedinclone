        ...
        {currentStep === 1 && (
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-center">
              <button
                onClick={onClose}
                className="bg-[#0017e7] font-sf text-white px-8 py-1 rounded-lg hover:bg-[#000f96] transition-colors"
              >
                Save
              </button>
              <button className="flex bg-gray-200 gap-2 border-[#000] text-gray-700 px-6 py-1 rounded-lg hover:bg-gray-300 transition-colors border font-sf">
                <Crop size={25} />
                Crop Image
              </button>
            </div>
