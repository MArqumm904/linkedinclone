    ...
    <div className="border border-[#000] rounded-lg p-6 bg-white relative shadow-sm">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="w-16 h-16 border border-[#4c4c4c] rounded-full flex items-center justify-center flex-shrink-0 bg-white">
          <img src="https://cdn.sanity.io/images/599r6htc/regionalized/5094051dac77593d0f0978bdcbabaf79e5bb855c-1080x1080.png?w=540&h=540&q=75&fit=max&auto=format" alt="Skill Icon" className="w-10 h-10 rounded-full" />
        </div>
